...
(function(){
    /**
     * @ngdoc service
     * @name derlin.modals.ModalService
     * @description
     * A service to easily show/hide modals using ui.bootstrap. See the DefaultModalController for an example of use.
     */
    angular
        .module( 'derlin.modals' )
